...
const StyledPlaylistItem = styled.div`
  ...
  .react-player__video-name,
  .react-player__video-name a {
  ...
  .react-player__video-download a {
    color: ${props =>
